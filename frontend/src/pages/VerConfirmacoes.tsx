// frontend/src/pages/Confirmacoes.tsx
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="space-y-1">
                    <p className="text-sm"><span>{confirmacaoSelecionada.equipamento_ligado ? '✅' : '❌'}</span> Equipamento ligado</p>
                    <p className="text-sm"><span>{confirmacaoSelecionada.sem_problemas_visuais ? '✅' : '❌'}</span> Sem problemas visuais</p>
                    <p className="text-sm"><span>{confirmacaoSelecionada.funcionando_normalmente ? '✅' : '❌'}</span> Funcionando normalmente</p>
                    {confirmacaoSelecionada.fonte_presente !== undefined && (
                      <p className="text-sm"><span>{confirmacaoSelecionada.fonte_presente ? '✅' : '❌'}</span> Fonte presente</p>
                    )}
                    {confirmacaoSelecionada.teclado_presente !== undefined && (
                      <p className="text-sm"><span>{confirmacaoSelecionada.teclado_presente ? '✅' : '❌'}</span> Teclado presente</p>
                    )}
                    {confirmacaoSelecionada.mouse_presente !== undefined && (
                      <p className="text-sm"><span>{confirmacaoSelecionada.mouse_presente ? '✅' : '❌'}</span> Mouse presente</p>
                    )}
                  </div>
                </div>
